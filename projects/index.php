...
<?php include $_SERVER['DOCUMENT_ROOT'].'/novel/includes/header.html'; ?>
	...
	<main role="main">
        <article class="row clearfix">
        	...
        	<section class="col2">
        		<p>These are a few of my creations. Some are for work, others for play. Skim the top to see my latest accomplishments, or start at the bottom and see how far I've come.</p>
...
<!-- marketing works -->
		<section class="col2">
			<h2 class="sectionTitle">Marketing Works</h2>
		</section>
		...
		<figure class="col1">
			...
			<figcaption>
				<p>March 2015</p>
				<p>Wordpress - Composer - Bower - Gulp</p>
			</figcaption>
		</figure>
...
<!-- sem tool -->
		<section class="col2">
			<h2 class="sectionTitle">SEM Reporting Tool</h2>
		</section>
...
<!-- ninjaflex -->
		<section class="col2">
			<h2 class="sectionTitle">NinjaFlex</h2>
		</section>
...
<!-- holly hill hospital -->
		<section class="col2">
			<h2 class="sectionTitle">Holly Hill Hospital</h2>
		</section>
		...
		<figure class="col1">
			...
			<figcaption>
				...
				<p>Responsive Design - HTM5 - Wordpress</p>
			</figcaption>
		</figure>
...
<!-- townlively -->
		<section class="col2">
			<h2 class="sectionTitle">TownLively - Marketplace</h2>
		</section>
...
<!-- lancaster county mag -->
		<section class="col2">
			<h2 class="sectionTitle">Lancaster County Magazine</h2>
		</section>
...
<!-- gilbert architects -->
		<section class="col2">
			<h2 class="sectionTitle">Gilbert Architects</h2>
		</section>
...
<!-- camp hebron - website -->
        	<section class="col2">
        		<h2 class="sectionTitle">Camp Hebron - Website</h2>
        	</section>
...
<!-- portfolio - version 2.0 -->
			<section class="col2">
				<h2 class="sectionTitle">Portfolio - Version 2.0</h2>
			</section>
			...
			<figure class="col1">
				...
				<figcaption>
					<p>June 2014</p>
					<p>HTML5 - CSS3 - PHP - AJAX - JavaScript - Responsive Design</p>
				</figcaption>
			</figure>

			<section class="col2">
				<p>I've been updating my portfolio with new projects and content since I created it in 2011, but I never updated the code. I've learned much since then. I thought this site should reflect that. So I implemented some new things: HTLM5 elements, a responsive design, contact form validation that actually does its job, clean URLs, and a site structure that makes a little more sense and allows for expansion. The visual style is less about bells and whistles and more about letting my personality shine through. There are still plenty of things that will need fixing, but after all was said and done, I sat back and looked at a site that I was truly proud to call my own.</p>

				<p><a href="/">You're Already Here...</a></p>
...
<!-- camp hebron - rebrand -->
        	<section class="col2">
        		<h2 class="sectionTitle">Camp Hebron - Rebrand</h2>
        	</section>

        	<figure class="col1">
        		<picture>
					<img src="/images/hebron-rebrand.png" alt="Camp Hebron - Rebrand">
        		</picture>

        		<figcaption>
        			<p>October 2013 - March 2014</p>
        			<p>Adobe Creative Suite - Design - Marketing</p>
        		</figcaption>
        	</figure>

        	<section class="col2">
        		<p>This was my first official rebrand and like most others, I imagine, it was a complex balancing act. As the Marketing Director, I was given full control of the process. I could've easily just designed a logo according to my tastes and called it a day. But to do so would be to toss out the 50+ years of the organization's history, the vision for its future, and the opinions of the board, the staff, and the stakeholders. It would also fly in the face of the true purpose of design: not just to make something pretty, but to solve a problem. The problem here was to bring the organization into a new season of life and to continue being relevant to consumers while not alienating the established customers with something new and foreign.</p>

        		<!-- <p><a href="camphebron/rebrand">-Read More-</a></p> -->
...
<!-- scriptorium -->
			<section class="col2">
				<h2 class="sectionTitle">Scriptorium</h2>
			</section>
...
<!-- how to grow a story -->
			<section class="col2">
				<h2 class="sectionTitle">How To Grow A Story</h2>
			</section>
...
<!-- whodunit? -->
			<section class="col2">
				<h2 class="sectionTitle">Whodunit?</h2>
			</section>
			...
			<figure class="col1">
				...
				<figcaption>
					<p>Spring 2012</p>
					<p>Interactive Design - QR Codes</p>
					<p>Archived</p>
				</figcaption>
			</figure>
...
<!-- lexington technologies -->
			<section class="col2">
				<h2 class="sectionTitle">Lexington Technologies</h2>
			</section>
...
<!-- music molds -->
			<section class="col2">
				<h2 class="sectionTitle">Music Molds</h2>
			</section>
...
<!-- sportfitdeal -->
			<section class="col2">
				<h2 class="sectionTitle">SportFitDeal</h2>
			</section>

			<figure class="col1">
				<picture>
					<img src="/images/sfdweb.png" alt="SportFitDeal" >
				</picture>
			...
			<section class="col2">
				<p>SportFitDeal was a web startup in the Philadelphia area that offered deals for local businesses in the health and fitness industry. After primary construction was completed by lead developer but before launch, I was hired as the Product &amp; Support Expert. My main duties were to head up site maintenance and customer support. I ensured compatibility of upgrades, both of Wordpress and plug-ins. I pushed out all major updates and daily updates of the website. I also assisted customers directly with account questions and technical problems. After the Marketing Intern resigned, I took on her duties working directly under the owner. I designed all of the advertising pieces and started a business to business affiliate program.</p>
...
<!-- portfolio - version 1.0 -->
			<section class="col2">
				<h2 class="sectionTitle">Portfolio - Version 1.0</h2>
			</section>
...
<!-- philosophy of the human -->
			<section class="col2">
				<h2 class="sectionTitle">Philosophy Of The Human</h2>
			</section>
...
<!-- f.d.s. -->
			<section class="col2">
				<h2 class="sectionTitle">F.D.S.</h2>
			</section>
...
<!-- thanksgiving party -->
			<section class="col2">
				<h2 class="sectionTitle">Thanksgiving Party</h2>
			</section>
...
<!-- mortgage calculator -->
			<section class="col2">
				<h2 class="sectionTitle">Mortgage Calculator</h2>
			</section>
...
<!-- where the wild is -->
			<section class="col2">
				<h2 class="sectionTitle">Where the Wild is</h2>
			</section>

			<figure class="col1">
				<!-- <picture>
					<img src="image.jpg" alt="Where the Wild is" >
				</picture> -->
			...
			<section class="col2">
				<p>This is where it all began. During my year off of school in between Drexel and Temple, I needed something to keep my mind active. I decided to build myself a Wordpress blog to learn how to code. It was a big undertaking, and I had no idea how far the rabbit hole went, but I dove in. I would wake up hours before my shift at the coffee shop and pour over the Wordpress codex. I mixed and mashed a Frankenstein monster out of my favorite bits from tutorial sites. I went through introductory lessons of HTML and CSS. I learned about domains and hosting, about coding by hand versus WYSIWYG editors, about valid code and semantics. I also learned a million ways to break a website. But I finished it. I proudly started blogging about all the tips and tricks about the outdoors that I knew. Then I ran out of article ideas. So I came up with more websites to build. That was the fun part anyways.</p>
        		<hr>
			</section>
		</article>
	</main>

<?php include $_SERVER['DOCUMENT_ROOT']."/novel/includes/footer.html"; ?>
